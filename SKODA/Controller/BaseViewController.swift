...
//            print("Play\n", terminator: "")
//
//            self.openViewControllerBasedOnIdentifier("NewsView")
//
//            break
//        case 2:
//            self.openViewControllerBasedOnIdentifier("TryAndLookView")
        case 1:
...
//                arrayMenuOptions.append(["title":"登出", "icon":"spot"])
                ...
                self.openViewControllerBasedOnIdentifier("loginView")
            }
    ...
    @objc func onSlideMenuButtonPressed(_ sender : UIButton){
        if (sender.tag == 10)
        {
            ...
            UIView.animate(withDuration: 0.3, animations: { () -> Void in
                ...
                frameMenu.origin.x = 1 * UIScreen.main.bounds.size.width //1: 縮回右邊, -1: 縮回左邊
